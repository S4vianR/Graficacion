...
void drawTriangleFan() {
    ...
    GLfloat vertices[] = {
        150.0, 370.0 + 250, // Vértice superior
        70.0, 300.0 + 250, // Vértice superior izquierdo
        100.0, 220.0 + 250, // Vértice inferior izquierdo
        200.0, 220.0 + 250, // Vértice inferior derecho
        230.0, 300.0 + 250 // Vértice superior derecho
    };
...
void drawTriangleStrip() {
    ...
    glVertex2f(100, -200.0); // Base izquierda
    glVertex2f(200, -50.0); // Vértice superior izquierdo
    glVertex2f(300, -200.0); // Base centro
    glVertex2f(400, -50.0); // Vértice superior izquierdo
    glVertex2f(500, -200.0); // Base derecha
    glEnd();
}
...
void drawTriangleStripWithTriangles() {
    glBegin(GL_TRIANGLES);
    glColor3f(azul.getR(), azul.getG(), azul.getB());
    glVertex2f(350, 460); // Vértice 1
    glVertex2f(400.0, 525); // Vértice 2
    glVertex2f(450.0, 460); // Vértice 3
    glVertex2f(400.0, 525); // Vértice 2
    glVertex2f(450.0, 460); // Vértice 3
    glVertex2f(500.0, 525); // Vértice 4
    glVertex2f(450.0, 460); // Vértice 3
    glVertex2f(500.0, 525); // Vértice 4
    glVertex2f(550.0, 460); // Vértice 5
    glEnd();
}
